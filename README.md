...
and reproducible via `evaluation/benchmark\\\_qualitative.py`.
...
python plot\\\_losses.py    # regenerates loss\\\_curve.png
```
...
Qualitative (3-model comparison table, requires `GEMINI\\\_API\\\_KEY` for the Gemini column):
